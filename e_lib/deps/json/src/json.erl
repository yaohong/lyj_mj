...
-define(JSON_ENCODE_ERROR(Err), {'json_encode_error', Err}).
-define(JSON_DECODE_ERROR(Err), {'json_decode_error', Err}).
...
-type json_term() :: json_string() | json_number() | json_boolean() | json_null() | json_array() |
                     json_object() | json_iolist().

-record(encoder, {}).
-record(decoder, {offset = 0,
                  line = 1,
                  column = 1,
                  state = null}).
